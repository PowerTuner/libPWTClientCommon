...
namespace PWT {
    class PWTCLIENTCOMMON_EXPORT StartupUtilWindows final: public StartupUtil {
    private:
        static constexpr wchar_t runPath[] = LR"(Software\Microsoft\Windows\CurrentVersion\Run)";
        std::wstring appName;

    public:
        explicit StartupUtilWindows(const QString &name);
